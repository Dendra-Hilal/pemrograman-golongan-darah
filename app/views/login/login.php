...
<head>
  ...
  <title>Golongan Darah Info | Login</title>
...
<div class="login-box">
  <div class="login-logo">
    <b>Golongan</b><b style="color: red;">Darah</b>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
      ...
      <form action="<?= base_url; ?>/login/prosesLogin" method="post">
        ...
        <div class="row">
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" class="btn btn-primary btn-block" style="background-color: red; border-color: red;">Sign In</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
