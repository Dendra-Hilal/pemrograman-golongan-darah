    ...
    <div class="col-sm-12">
      ...
      <div class="card">
        <div class="card-header">
          <h3 class="card-title"><?= $data['title'] ?></h3> <div class="btn-group float-right"><a href="<?= base_url; ?>/goldar/tambah" class="btn float-right btn-xs btn btn-primary">Tambah Golongan Darah</a><a href="<?= base_url; ?>/goldar/laporan" class="btn float-right btn-xs btn btn-info">Laporan Buku</a><a href="<?= base_url; ?>/goldar/lihatlaporan" class="btn float-right btn-xs btn btn-warning">Lihat Laporan Golongan Darah</a></div>
        </div>
        <div class="card-body">
          ...
          <table class="table table-bordered">
                  <thead>                  
                    <tr>
                      ...
                      <th>Presentasi Jumlah Masyarakat</th>
                      <th>Jumlah Laki-Laki</th>
                      <th>Presentasi Jumlah Laki-Laki</th>
                      <th>Jumlah Perempuan</th>
                      <th>Presentasi Jumlah Perempuan</th>
