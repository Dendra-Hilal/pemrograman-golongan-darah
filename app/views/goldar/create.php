  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Tambahkan Golongan Darah</h1>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    </section>
...
<div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="<?= base_url; ?>/goldar/simpanGoldar" method="POST" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Masukkan presentasi jumlah masyarakat..." name="persen_total">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label>Persentase Jumlah Laki-Laki</label>
                    <input type="text" class="form-control" placeholder="Masukkan presentasi jumlah laki-laki..." name="persen_laki">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Masukkan presentasi jumlah perempuan..." name="persen_perempuan">
                  </div>
                </div>
                <!-- /.card-body -->
