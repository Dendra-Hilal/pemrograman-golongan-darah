              ...
              <form role="form" action="<?= base_url; ?>/buku/updateBuku" method="POST" enctype="multipart/form-data">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Masukkan persentasi jumlah masyarakat..." name="persen_total" value="<?= $data['goldar']['persen_total'];?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Masukkan persentasi jumlah laki-laki..." name="persen_laki" value="<?= $data['goldar']['persen_laki'];?>">
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Masukkan persentasi jumlah perempuan..." name="persen_perempuan" value="<?= $data['goldar']['persen_perempuan'];?>">
                  </div>
                </div>
                <!-- /.card-body -->
